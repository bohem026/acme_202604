...
const swiperSlide = new Swiper(".slidewrapper", {
  direction: "horizontal",
  loop: true,
  pagination: {
    el: ".slidewrapper .swiper-pagination",
    clickable: true,
  },
});

const csprevBtn = document.querySelector(".slidewrapper .prev");
const csnextBtn = document.querySelector(".slidewrapper .next");
